<template>
    <div class="demo-game">
        ...
        <div class="game">
            ...
            <ul class="bet-num">
                <li v-for="item in 10" class="item-num" @click="clickNum(item-1,$event)" :class="{active:activeNums.includes(item-1)}">
                    <p class="num">{{ item-1 }}</p>
                    <p class="winamount">10</p>
                </li>
            </ul>
            ...
            <div class="change-bottom">
                ...
                <div class="center">
                    ...
                    <span>注</span>
                    <span>,</span>
                    <span class="num">{{ activeNums.length*2*multiple }}</span>
                    <span>元</span>
                </div>
                <div class="bottom">
...
const betNow=()=>{
    demoGameMoney.value-=activeNums.value.length*2*multiple.value
    activeNums.value=[]
}
const keyframes= [
  { scale: 0.9 },
